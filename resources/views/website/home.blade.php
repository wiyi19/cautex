...
<div class="container">
	<div class="row mt-5">
		...
		<a href="{{ route('website.familia', $item->id) }}" class="col-md-4 home-familia-box" style="background-image: url({{ asset(Storage::url($item->imagen)) }});">
...
<div class="home-matrices mt-10" style="background-image: url({{ asset(Storage::url($matrices->imagen))}});">
	<div class="home-matrices-overlay">
		<div class="home-matrices-container">
			...
			<a href="{{ route('website.matriceria') }}" class="btn btn-outline-light btn--style-custom">Ingresar</a>
		</div>
	</div>
</div>
@endsection
