...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<div>
		<a href="{{ route('adm.imagenmatriceria') }}" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
...
<div class="row">
	<form class="col s12" method="POST" action="{{ route('adm.imagenmatriceria.update', $element->id) }}" enctype="multipart/form-data">
		@csrf
		<div class="row">
