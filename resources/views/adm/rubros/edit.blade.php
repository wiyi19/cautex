...
<div class="row">
	<form class="col s12" method="POST" action="{{ route('adm.rubros.update', $element->id) }}" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-xl-12 col-lg-12">
				<div class="card shadow mb-4">
					...
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						<h6 class="m-0 font-weight-bold text-primary">Editar una Rubro</h6>
					</div>
					<!-- Card Body -->
